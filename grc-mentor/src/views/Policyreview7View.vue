 ...
 <!-- Main Policy Page -->
        <div class="policy-page flex-grow-1">
            ...
            <div class="d-flex justify-content-between align-items-start p-4 ">
                ...
                <button class="btn btn-link text-decoration-none" @click="$emit('close')"><i class="bi bi-x-circle-fill" style="color: #0096D6;"></i> Close</button>
            </div>
            ...
            <div class="p-4">
                ...
                <div class="mb-4  rounded p-3">
                    ...
                    <div>
                        ...
                        <p class="text-muted" style="white-space: pre-line;">{{ policy.subtasks[0].instructions }}</p>
