              ...
              <section class="industries-card glass-card h-100">
                ...
                <div class="industries-grid">
                  <div v-for="(industry, index) in industries" :key="index" class="industry-card"
                    :style="{ backgroundImage: 'url(' + industry.image + ')' }" @click="openModal(industry)">
                ...
                <ul class="roles-list">
                  <li v-for="(role, index) in roles" :key="index" class="role-item">
                    ...
                    <div class="form-check gap-2 mt-lg-2">
                      ...
                      <span class="text-primary small text-decoration-underline " @click="openPolicyModal">
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      activeIndustry: null as Industry | null,
