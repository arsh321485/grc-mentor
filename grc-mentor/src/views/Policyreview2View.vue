            ...
            <div class="col-12 col-md-10">
                ...
                <div class="policy-page flex-grow-1">
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-start p-4">
                        ...
                        <button class="btn text-decoration-none p-0 mt-2" @click="$emit('close')"
                            style="color: #0096D6;">
                            <i class="bi bi-x-circle-fill" style="color: #0096D6; font-size: 20px"></i>
                            Close
                        </button>
                                                    ...
                                                    <div class="dropdown ms-auto">
                                                        ...
                                                        <ul v-if="openDropdown === 'methods'" class="dropdown-content">
                                                            <li>
                                                                <!-- Methods -->
                                                                <a href="#"
                                                                    @click.prevent="toggleSubmenu('methods-sub')">
                                                                    <span class="color">
                                                                ...
                                                                <!-- Level 2 -->
                                                                <ul v-if="openSubmenu === 'methods-sub'"
                                                                    ...
                                                                    <li class=" ">
                                                                        <a href="#"
                                                                            @click.prevent="toggleSubmenu('methods-action-sub')">
                                                                            <span class="color">
