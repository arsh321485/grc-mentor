          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
              <div class="row g-4 align-items-center">
                ...
                <!-- Summary -->
                <div class="col-md-7">
                  <h5 class="mb-2">Placement: <span :class="['badge', levelBadgeClass]">{{ displayLevel }}</span></h5>
                  <p class="text-muted mb-3">
                    Based on your performance, we’ve mapped you to the most suitable track.
                  ...
                  <ul class="list-unstyled mb-4">
                    ...
                    <li class="d-flex align-items-center">
                      <span class="dot me-2"></span>
                      Qualifi for Program: <strong class="ms-1">{{ displayLevel }}</strong>
                    </li>
                  </ul>
                  ...
                  <div class="d-flex flex-wrap gap-2">
                    ...
                    <router-link to="/profileset" class="btn btn-success">
                      Proceed to Profile Setup
                    </router-link>
                    <!-- 
