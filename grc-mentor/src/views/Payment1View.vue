                  ...
                  <div class="card border-0 shadow-sm mb-4">
                    ...
                    >
                      ...
                      <div v-if="selected === 'card'" class="mt-3">
                        ...
                        <div class="row g-2">
                          <div class="col-md-8">
                            <input v-model="card.number" maxlength="19" placeholder="Card number"
                              class="form-control" />
                          </div>
                          <div class="col-md-4">
                      ...
                      <div v-if="selected === 'paypal'" class="mt-3">
                        ...
                        <p class="small text-muted">We will redirect you to the provider's secure checkout
                          (multi-currency supported).</p>
                        <div class="mb-2">
                          <button class="btn btn-outline-primary" @click="startPaypalFlow" :disabled="isProcessing">Pay
                            via PayPal</button>
                        </div>
                      </div>
                      ...
                      <div class="mt-4">
                        ...
                        <div v-if="couponMsg" class="small mt-2"
                  ...
                  <div class="card border-0 shadow-sm position-sticky" style="top: 90px;">
                    <div class="card-body p-4">
                      ...
                      <router-link to="/paymentsuccess">
                        <button class="btn btn-submit w-100 mb-2" :disabled="!canProceed || isProcessing">
