        ...
        <div class="col-10 col-md-10">
          ...
          <section>
            <div class="row g-4 mb-4">
              ...
              <div class="col-md-6">
                <section class="industries-card glass-card">
                  ...
                  <div class="d-flex flex-column">
                    ...
                    <!-- Info -->
                    <p class="info-text">{{ form.email }}</p>
                    <button
                      type="button"
                      class="mattermost-btn w-75 btn-submit"
                      @click="openModal"
                    >
                  ...
                  <div class="status-box">
                    ...
                    <p
                      class="text-center status-text mb-0"
                  ...
                  <!-- Button -->
                  <router-link to="/welcomementor" class="next-btn btn-submit ms-1">
              ...
              <!-- Right Card -->
              <div class="col-md-6">
                <section class="roles-card glass-card">
                  <!-- You can put responsibilities content here -->
                </section>
              </div>
            </div>
          </section>
