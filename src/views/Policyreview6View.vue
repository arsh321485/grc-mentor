        ...
        <div class="col-12 col-md-10">
            ...
            <div class="policy-page flex-grow-1">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-start p-4">
                    ...
                    <button class="btn btn-link text-decoration-none p-0 mt-2" @click="$emit('close')">
             ...
             <!-- Subtasks count -->
                <div class="text-muted ms-4 mb-3">
                    <span class="fs-6">Subtasks</span> ({{ policy.subtasks.length }})
                </div>
                            ...
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse" :data-bs-target="'#flush-collapse' + index" aria-expanded="false" :aria-controls="'flush-collapse' + index">
                                    ...
                                    <span class="w-100 d-flex justify-content-between align-items-center">
                                        ...
                                        <h6 class="fw-semibold mb-0"><i class="bi bi-check-circle-fill" style="color: #0096D6;"></i> {{ task.name }}</h6>
            ...
            <h6 class="fw-semibold mb-2">Task marked as complete!</h6>
            <p class="text-muted mb-0">
              Please send an email to your mentor informing him:
            </p>
            <small class="color">Send email  <i class="bi bi-arrow-right"></i></small>
          </div>
            </div>
        </div>
        <!-- col-10 -->
